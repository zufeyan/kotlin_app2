package com.sctgold.goldinvest.android.fcm
...
import com.sctgold.goldinvest.android.MyWorker
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    val PRICE_ALERT = "com.clevel.goldinvest.android.service.PRICE_ALERT"
    /**
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        remoteMessage.notification?.let {
            ...
            remoteMessage.data["title"]?.let { it1 -> remoteMessage.data["message"]?.let { it2 ->
                sendNotification(
                    it1,
                    it2
                )

...
import com.sctgold.goldinvest.android.ExpandableLayout
...
import com.sctgold.goldinvest.android.dto.NotificationDetailDTO
        ...
        override fun onBindViewHolder(holder: ViewHolder, @SuppressLint("RecyclerView") position: Int) {
            ...
            if (!cells.notificationRead) {
                ...
                holder.itemView.notice_icon_title.colorFilter = PorterDuffColorFilter(
                    ContextCompat.getColor(context, R.color.email_unread_icon_bg), PorterDuff.Mode.SRC_IN
                )
                ...
                holder.itemView.notice_title.setTextColor(
                    ContextCompat.getColor(context, R.color.tint_notice_unread_title)
                )
                ...
                holder.itemView.notice_icon_title.colorFilter = PorterDuffColorFilter(
                    ContextCompat.getColor(context, R.color.email_read_icon_bg), PorterDuff.Mode.SRC_IN
                )
                ...
                holder.itemView.notice_title.ellipsize = TextUtils.TruncateAt.END
                holder.itemView.notice_title.setTextColor(
                    ContextCompat.getColor(context, R.color.tint_notice_read_title)
                )
            ...
            holder.itemView.expand_layout.setOnExpandListener(object :
                ...
                override fun onExpand(expanded: Boolean) {
                    if (expandedPositionSet.contains(position)) {
                        ...
                        holder.itemView.card_notice.setCardBackgroundColor(
                            ContextCompat.getColor(context, R.color.tint_card_bg)
                        )
                        ...
                        holder.itemView.notice_title.setTextColor(
                            ContextCompat.getColor(context, R.color.title_card_text)
                        )

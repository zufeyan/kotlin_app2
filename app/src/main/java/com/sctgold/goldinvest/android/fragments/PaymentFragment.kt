...
import com.sctgold.goldinvest.android.dto.ActionResult
import com.sctgold.goldinvest.android.listener.OnResultPermissionCallbackListener
...
class PaymentFragment : Fragment() , OnResultPermissionCallbackListener {
    ...
    class HeaderViewHolder(inflater: LayoutInflater, parent: ViewGroup) :
        RecyclerView.ViewHolder(inflater.inflate(R.layout.row_set_header_payment, parent, false)) {
    ...
    class PaymentViewHolder(inflater: LayoutInflater, parent: ViewGroup) :
        ...
        fun bind(data: DataAttach) {
            ...
            wgIcon?.colorFilter = PorterDuffColorFilter(
                ContextCompat.getColor(v.context, R.color.payment_icon_bg),
                PorterDuff.Mode.SRC_IN
            )

            wgType?.text = data.names
            wgType?.setTextColor(ContextCompat.getColor(v.context, R.color.tint_payment))

package com.sctgold.goldinvest.android.service
...
import com.sctgold.goldinvest.android.dto.NotifyEvent
import com.sctgold.goldinvest.android.dto.ServiceStatus
...
//                    bundle!!.getString("com.clevel.goldinvest.android.EVENT_SOCKET_URL")
//            } else {
                //   LogUtil.debug(TAG, "Start Service using latest Login Info from preferences")
//                val sharedPreferences = getSharedPreferences(
//                    getString(com.clevel.goldinvest.android.R.string.key_prefs_session_initialized),
//                    MODE_PRIVATE
//                )
//                sharedPreferences.getString(
//                    getString(com.clevel.goldinvest.android.R.string.key_session_eventURL),
//                    null
//                )
//                eventURI =PropertiesKotlin.WEB_SOCKET_URL+PropertiesKotlin.pathEvent
//            }
...
//            disconnectSocket();
    ...
    companion object {
        ...
        val TAG = "EVENT_FEED"
        val FORCE_LOGOUT_NOTIFICATION = "com.clevel.goldinvest.android.service.EVENT_FORCE_LOGOUT"
        val PRICE_ALERT_UPDATE_NOTIFICATION =
            "com.clevel.goldinvest.android.service.EVENT_PRICE_ALERT_UPDATE"

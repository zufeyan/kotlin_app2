...
//            if (bundle != null) {
//                systemURI = bundle!!.getString("com.clevel.goldinvest.android.CONFIG_SOCKET_URL")
...
//        disconnectSocket();
    ...
    companion object {
        ...
        val SYSTEM_NOTIFICATION = "com.clevel.goldinvest.android.service.SYSTEM_UPDATE_NOTIFICATION"

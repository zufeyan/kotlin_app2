...
//import androidx.cardview.widget.CardView
//import androidx.fragment.app.Fragment
//import com.clevel.tmgold.android.activities.HomeActivity
...
//
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        brand.setImageResource(R.drawable.brand)
...
//    }
    ...
    override fun onOptionsItemSelected(itemMenu: MenuItem): Boolean {
        when (itemMenu.itemId) {
            ...
            R.id.to_www -> {
                startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://www.ltsgoldonline.com")))
                return true
            }
        }

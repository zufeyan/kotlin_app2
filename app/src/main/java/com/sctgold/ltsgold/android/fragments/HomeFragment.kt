...
import com.sctgold.ltsgold.android.listener.OnReloadDataFragment
...
//                .addToBackStack("HOME").commit()
    ...
    private fun chatLine() {
        //val uri = Uri.parse("https://line.me/ti/p/@thaimithgold") // missing 'http://' will cause crashed // edit 18.04.23 by Chalermphan
        val uri = Uri.parse("https://line.me/ti/p/@ltsgold")  // add 18.04.23 by Chalermphan

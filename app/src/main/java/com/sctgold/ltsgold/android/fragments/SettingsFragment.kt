...
import com.sctgold.ltsgold.android.util.OnItemSelectListener
            ...
            when (data.check) {
                0 -> {
                        if (uiManager.nightMode == 1) {
                            auto?.setTextColor(Color.parseColor(PropertiesKotlin.colorWhite))
                            ...
                            dark?.setTextColor( Color.parseColor(PropertiesKotlin.colorDarkM))
                        }
        ...
        fun bind(data: SetLang) {
            ...
            when (data.check) {
                "TH" -> {
                    ...
                    if(select_theme == 0){
                        if (uiManager.nightMode == 1) {
                            thRdo.setTextColor(Color.parseColor(PropertiesKotlin.colorWhite))
                            enRdo.setTextColor( Color.parseColor(PropertiesKotlin.colorMainM))
                        } else {
                            //system dark
                            thRdo.setTextColor(Color.parseColor(PropertiesKotlin.colorBlack))
                            enRdo.setTextColor( Color.parseColor(PropertiesKotlin.colorDarkM))
                        }
                ...
                "EN" -> {
                    if(select_theme == 0){
                        if (uiManager.nightMode == 1) {
                            thRdo.setTextColor(Color.parseColor(PropertiesKotlin.colorMainM))
                            enRdo.setTextColor( Color.parseColor(PropertiesKotlin.colorWhite))
                        } else {
                            //system dark
                            thRdo.setTextColor(Color.parseColor(PropertiesKotlin.colorDarkM))

...
import com.sctgold.ltsgold.android.activities.IntentActivityUtils.GoldSpotFragment
import com.sctgold.ltsgold.android.activities.IntentActivityUtils.GoldSpotIntent
...
import com.sctgold.ltsgold.android.receiver.MobilePricingReceiver
import com.sctgold.ltsgold.android.receiver.MobileSystemReceiver
...
import com.sctgold.ltsgold.android.util.DecimalDigitsInputFilter
            ...
            when (group.checkedRadioButtonId) {
                R.id.select_real_time -> {
                    ...
                    if (select_theme == 0) {
                        if (uiManager.nightMode == 1) {
                            real.setTextColor(Color.parseColor(PropertiesKotlin.colorWhite))
                            place.setTextColor(Color.parseColor(PropertiesKotlin.colorMainM))
                            stop.setTextColor(Color.parseColor(PropertiesKotlin.colorMainM))

                        } else {
                            //system dark
                            real.setTextColor(Color.parseColor(PropertiesKotlin.colorBlack))
                            place.setTextColor(Color.parseColor(PropertiesKotlin.colorDarkM))
                            stop.setTextColor(Color.parseColor(PropertiesKotlin.colorDarkM))
                        }
                    } else if (select_theme == 1) {
                        real.setTextColor(Color.parseColor(PropertiesKotlin.colorWhite))
                        place.setTextColor(Color.parseColor(PropertiesKotlin.colorMainM))
                ...
                R.id.select_place_order -> {
                    ...
                    if (select_theme == 0) {
                        if (uiManager.nightMode == 1) {
                            real.setTextColor(Color.parseColor(PropertiesKotlin.colorMainM))
                            place.setTextColor(Color.parseColor(PropertiesKotlin.colorWhite))
                            stop.setTextColor(Color.parseColor(PropertiesKotlin.colorMainM))
                        } else {
                            //system dark
                            real.setTextColor(Color.parseColor(PropertiesKotlin.colorDarkM))
